...
def test_optimizer_visit_condition_node(
    node: nodes.ConditionNode, ctx: Context, expected: nodes.Node
) -> None:
    o = Optimizer({}, {}, ctx=ctx)
...
def test_optimizer_visit_macro_node(
    node: nodes.MacroNode,
...
def test_optimizer_visit_optional_node(
    node: nodes.OptionalNode, expected: nodes.Node
) -> None:
    o = Optimizer({}, {})
...
def test_optimizer_visit_entity_node_does_nothing_without_macro() -> None:
    ...
    entity_1 = nodes.EntityNode(
        "some_entity", [nodes.LiteralNode("a"), nodes.LiteralNode("b")]
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            nodes.LiteralNode("asdf"),
            nodes.ListNode([nodes.LiteralNode(" "), nodes.LiteralNode("asdf")]),
        ),
        (nodes.LiteralNode(","), nodes.LiteralNode(",")),
    ],
)
def test_optimizer_visit_literal_node(
    node: nodes.LiteralNode, expected: Optional[nodes.Node]
) -> None:
    o = Optimizer({}, {})
    ...
    [
        (
            ...
            nodes.AnyNode(
                [
                    nodes.ListNode(
                        [nodes.LiteralNode(" "), nodes.LiteralNode("hello")]
                    ),
                    nodes.ListNode(
                        [nodes.LiteralNode(" "), nodes.LiteralNode("world")]
                    ),
                ]
            ),
        ),
        (nodes.PlaceholderNode("a"), None, nodes.PlaceholderNode("a")),
        (
            nodes.PlaceholderNode("a"),
            Context({"b": "hello"}),
            nodes.PlaceholderNode("a"),
...
def test_optimizer_visit_placeholder_node(
    node: nodes.PlaceholderNode, ctx: Optional[Context], expected: nodes.Node
) -> None:
    o = Optimizer({}, {}, ctx=ctx)
